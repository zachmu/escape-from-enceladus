...
namespace Arena.Entity.NPC {
    ...
    public class DisembodiedSpeaker : IDialogEntity {
        ...
        public DisembodiedSpeaker(Color color) {
            _color = color;
        }

        public void DrawConversationText(SpriteBatch spriteBatch, Camera2D camera, string text) {
            // Our origin is the top-left corner of the screen, plus some (screen space) offsets.
            // NPCs need the coordinate in sim space, not screen space
